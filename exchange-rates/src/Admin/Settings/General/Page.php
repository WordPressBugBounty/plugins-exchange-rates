...
class Page
{
    ...
    public static function render()
    {
		...
		<div id="plugin-<?php echo esc_attr(Plugin::PLUGIN_SLUG); ?>-admin" class="wrap">
			<h1>
			...
			<div class="row">
				<div class="col">
					...
					<?php echo esc_html(gmdate('r', $settings['update_timestamp'])); ?></p>
					<?php } ?>
				...
				<div class="col">
					...
					<p>
						<button id="exchange-rates-force-data-update-button" class="button button-primary"><?php esc_html_e('Force Data Update', 'exchange-rates'); ?></button>
					</p>
					<div id="exchange-rates-force-data-update-message"></div>
					<?php } ?>
				</div>
			</div>
			<?php if ($rates) { ?>
			...
			<div class="row">
				...
				<h2><?php esc_html_e('Badge shortcode generator ', 'exchange-rates'); ?></h2>
					<form data-shortcode-generator="<?php echo esc_attr(Plugin::PLUGIN_SLUG); ?>_badge">
					<input type="hidden" name="id_base" value="<?php echo esc_attr(Plugin::PLUGIN_SLUG); ?>_badge" />
					...
					<input type="hidden" name="id" value="<?php echo esc_attr(time()); ?>">
					<hr>
					...
					<div>
						<div style="font-size:large">
							...
							<p style="font-size:x-large">🥰 <?php esc_html_e('Please rate plugin', 'exchange-rates'); ?>
								&laquo;<a href="https://wordpress.org/plugins/<?php echo esc_attr(Plugin::PLUGIN_SLUG); ?>/reviews/#new-post" rel="noopener" target="_blank"><?php echo esc_attr(Plugin::NAME); ?></a>&raquo;
								<a href="https://wordpress.org/support/plugin/<?php echo esc_attr(Plugin::PLUGIN_SLUG); ?>/reviews/#new-post" rel="noopener" target="_blank">
    <img src="<?php echo esc_url(plugin_dir_url($GLOBALS['dejurin_exchange_rates']->plugin_path) . 'assets/img/stars.png'); ?>" alt="<?php esc_html_e('Rating', 'exchange-rates'); ?>">
</a>
		...
		<p>V<?php echo esc_html(Plugin::VERSION); ?></p>
<?php
    }
}
