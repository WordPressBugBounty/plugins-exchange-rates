...
class CurrencyTable
{
    ...
    public static function render()
    {
		...
		echo '<div class="table-responsive">' . wp_kses_post($table->generate()) . '</div><p><button type="button" data-id="exchange-rates-currency-table-1" class="button show-more-table">' . esc_html__('Show More/Less', 'exchange-rates') . '</button></p>';
