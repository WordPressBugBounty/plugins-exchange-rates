...
class Currencies
{
    public static function get_list()
    {
        return [
            ...
            'XCG' => [
                'flag' => 'SX',
                'name' => esc_html__('Caribbean Guilder', 'exchange-rates'),
                'region' => esc_html__('Curaçao and Sint Maarten', 'exchange-rates'),
            ],
            'ZWG' => [
                'flag' => 'ZW',
                'name' => esc_html__('Zimbabwean ZiG', 'exchange-rates'),
                'region' => esc_html__('Zimbabwe', 'exchange-rates'),
            ],
        ];
    }
